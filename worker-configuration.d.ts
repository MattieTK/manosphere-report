/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 20ceccbb4674afb2aaa3c392ed9b88db)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		DB: D1Database;
		AI: Ai;
		EPISODE_WORKFLOW: Workflow<Parameters<import("./src/server").EpisodeProcessingWorkflow['run']>[0]['payload']>;
	}
}
